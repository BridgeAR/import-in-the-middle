...
export const IMPORT = 2 // [IMPORT, url]                 -> resolves to the module namespace

function runOp (op, io) {
  switch (op[0]) {
    case LOAD: return io.load(op[1], op[2])
    case RESOLVE: return io.resolve(op[1], op[2])
    case IMPORT: return io.dynamicImport(op[1])
    default: throw new TypeError(`Unknown loader I/O operation: ${op[0]}`)
  }
}
 ...
 * @param {{ load: Function, resolve?: Function, dynamicImport?: Function }} io
 * @returns {T}
 */
